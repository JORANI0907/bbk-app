      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-text-primary group-hover:text-brand-600 transition-colors">BBK 홈페이지</p>
              <p className="text-xs text-text-secondary mt-0.5 leading-normal">회사 소개 · 서비스 전체 안내</p>
            </div>
          ...
          {/* 정기딥케어 */}
          <a
            href="https://rhetorical-wool-362.notion.site/BBK-2f2fc2d565d780c8b0c3cb124d2e09cd"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-surface rounded-2xl border border-border-subtle shadow-soft p-5 flex items-center gap-4 group hover:bg-surface-sunken active:scale-[0.98] transition-all"
          >
          ...
          {/* 정기엔드케어 */}
          <a
            href="https://rhetorical-wool-362.notion.site/BBK-2ccfc2d565d78002be29e5e9fa14d71f"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-surface rounded-2xl border border-border-subtle shadow-soft p-5 flex items-center gap-4 group hover:bg-surface-sunken active:scale-[0.98] transition-all"
          >
