        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 pt-5 pb-2">
              ...
              <button onClick={reset} className="text-text-tertiary hover:text-text-primary text-lg leading-none transition-colors" aria-label="닫기">✕</button>
            </div>
            ...
            <div className="flex gap-2 px-5 pb-5">
              <button onClick={reset} className="flex-1 py-3 rounded-xl border border-border text-sm font-semibold text-text-secondary hover:bg-surface-sunken transition-colors">취소</button>
              <button onClick={() => setStep('form')} className="flex-1 py-3 rounded-xl bg-brand-600 text-white text-sm font-bold hover:bg-brand-700 transition-colors">확인</button>
            </div>
          </div>
        </div>
      )}
            ...
            {done ? (
              ...
              <>
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={reset} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-surface-sunken text-text-tertiary transition-colors" aria-label="닫기">✕</button>
                </div>
