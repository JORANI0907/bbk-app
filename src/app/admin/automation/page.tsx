...
const ALIMTALK_TEMPLATES: AlimtalkTemplate[] = [
  ...
  },
  {
    ...
    body: '[BBK 공간케어] {고객명}님,\n{상호명} 정기케어 방문 예정일을 안내드립니다.\n\n■ 방문 예정일: {방문예정일}\n\n일정 변경은 고객 포털에서 요청해 주세요.\n문의: 010-5434-4877',
  },
  {
  ...
  {
    id: 'payment-cron', category: '결제', templateCode: 'KA01TP260324125232471CIIHJKDOBsf', name: '잔금 결제 요청',
    variables: ['고객명', '청소비용'],
    trigger: '작업완료 후 결제 전 건 매일 반복 (정기엔드케어 제외)', triggerType: 'auto', schedule: '매일 06:00 KST',
    body: '[BBK 공간케어] {고객명}님,\n잔금 결제를 요청드립니다.\n\n■ 청소비용(잔금): {청소비용}원\n\n문의: 031-759-4877',
  },
  {
    id: 'billing-cash', category: '결제', templateCode: 'KA01TP251127095540783njh0ig3nyjg', name: '결제 요청 (현금)',
    variables: ['고객명', '청소비용'],
    trigger: '작업완료 후 미결제 매일 반복 — 현금', triggerType: 'auto', schedule: '매일 06:00 KST',
    body: '[BBK 공간케어] {고객명}님,\n현금 잔금 결제를 요청드립니다.\n\n■ 청소비용(잔금): {청소비용}원\n\n문의: 031-759-4877',
  },
  {
    id: 'billing-card', category: '결제', templateCode: 'KA01TP251201210650817mczUreAtEjU', name: '결제 요청 (카드·플랫폼)',
    variables: ['고객명', '청소비용'],
    trigger: '작업완료 후 미결제 매일 반복 — 카드·플랫폼', triggerType: 'auto', schedule: '매일 06:00 KST',
    body: '[BBK 공간케어] {고객명}님,\n카드/플랫폼 결제를 안내드립니다.\n\n■ 청소비용(총액): {청소비용}원\n\n문의: 031-759-4877',
  },
  {
