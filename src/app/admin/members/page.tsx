    ...
    <div className="p-6 max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">직원·고객 계정을 등록하면 OTP로 로그인 가능</p>
        </div>
      ...
      {showForm && (
        <Card className="p-5 mb-4 border-blue-200 bg-blue-50">
          ...
          <div className="space-y-3">
            ...
            {/* 전화번호 */}
            <div>
              <label className="text-xs font-medium text-gray-600 mb-1.5 block">전화번호 * (로그인에 사용)</label>
              <input
                type="tel"
                value={form.phone}
