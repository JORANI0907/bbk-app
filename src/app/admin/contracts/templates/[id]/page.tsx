  ...
  return (
    <div className="space-y-5">
      ...
      {extractTemplateVars(htmlBody).length > 0 && (
        <div className="bg-brand-50 rounded-2xl shadow-soft border border-brand-200 p-5 space-y-4">
          <div>
          ...
          <div className="space-y-4">
            {extractTemplateVars(htmlBody).map(v => {
              ...
              return (
                <div key={v} className="bg-surface border border-brand-100 rounded-xl p-4 space-y-3 shadow-flat">
                  {/* 변수명 + 설명 */}
