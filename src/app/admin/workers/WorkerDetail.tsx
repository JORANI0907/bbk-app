  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const workerForPDF: Worker = {
        ...worker,
        name: form.name,
        employment_type: (form.employment_type || null) as Worker['employment_type'],
        birth_date: form.birth_date || null,
        gender: form.gender || null,
        blood_type: form.blood_type || null,
        phone: form.phone || null,
        email: form.email || null,
        home_address: form.home_address || null,
        department: (form.department || null) as Worker['department'],
        position: form.position || null,
        job_title: form.job_title || null,
        join_date: form.join_date || null,
        skill_level: (form.skill_level || null) as Worker['skill_level'],
        specialties: form.specialties || null,
        account_number: form.account_number || null,
