...
function buildFallback(type: string, customer: Record<string, unknown>): string {
  ...
  const map: Record<string, string> = {
    '정기결제알림': `[BBK 공간케어] ${name}님, ${bizName} 정기케어 결제일이 다가왔습니다. 문의: 1522-9597`,
    '정기결제알림(현금)': `[BBK 공간케어] ${name}님, ${bizName} 정기케어 현금 결제일이 다가왔습니다. 문의: 1522-9597`,
    '정기결제알림(카드)': `[BBK 공간케어] ${name}님, ${bizName} 정기케어 카드 결제일이 다가왔습니다. 문의: 1522-9597`,
    '정기방문알림': `[BBK 공간케어] ${name}님, ${bizName} 정기케어 방문 예정일이 다가왔습니다. 문의: 1522-9597`,
    '계약갱신알림': `[BBK 공간케어] ${name}님, ${bizName} 계약 만료가 다가왔습니다. 갱신 문의: 1522-9597`,
    '건당결제알림': `[BBK 공간케어] ${name}님, ${bizName} 건당 서비스 결제를 안내드립니다. 문의: 1522-9597`,
    '방문견적알림': `[BBK 공간케어] ${name}님, 방문 견적 일정을 안내드립니다. 문의: 1522-9597`,
    ...
    '계정안내알림': `[BBK 공간케어] ${name}님, 고객 포털 계정 정보를 안내드립니다. 문의: 1522-9597`,
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (linkedPayment) {
      ...
      const PAID_STATUSES = ['결제완료', '카드결제 완료', '비과세']
